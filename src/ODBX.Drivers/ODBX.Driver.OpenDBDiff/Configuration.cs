            ...
            Options = new List<DriverOption>
                          {
                              ...
                              new DiffOption(categoryFilters, "Table File Groups", "", false, OptionType.FilterTableFileGroup),
                              new DiffOption(categoryFilters, "Extended Properties", "", false, OptionType.FilterExtendedProperties),
                              ...
                              new DiffOption(categoryFilters, "Not For Replication", "", false, OptionType.FilterNotForReplication),
                              new DiffOption(categoryFilters, "Column Collation", "", false, OptionType.FilterColumnCollation),
                              ...
                              new DiffOption(categoryFilters, "Index Row Locks", "", false, OptionType.FilterIndexRowLock),
                              new DiffOption(categoryFilters, "Index Include Columns", "", true, OptionType.FilterIndexIncludeColumns),
                              new DiffOption(categoryFilters, "Index Fill Factor", "", false, OptionType.FilterIndexFillFactor),
                              new DiffOption(categoryFilters, "Constraint Checks", "", true, OptionType.FilterConstraintCheck),
                              new DiffOption(categoryFilters, "Unique Key Constraints", "", false, OptionType.FilterConstraintUniqueKey),
                              new DiffOption(categoryFilters, "Foreign Key Constraints", "", false, OptionType.FilterConstraintForeignKey),
                              new DiffOption(categoryFilters, "Primary Key Constraints", "", false, OptionType.FilterConstraintPrimaryKey),
                              ...
                              new DiffOption(categoryFilters, "Partition Schemes", "", false, OptionType.FilterPartitionScheme),
                              new DiffOption(categoryFilters, "Partition Functions", "", false, OptionType.FilterPartitionFunction),
                              new DiffOption(categoryComparison, "Rebuild views using SCHEMABINDING with DROP/CREATE statements", "", false, OptionType.ScriptAlterObjectOnSchemaBinding),
                              new DiffOption(categoryComparison, "Ignore White Space", "", true, OptionType.ComparisonIgnoreWhiteSpacesInCode),
                              new DiffOption(categoryComparison, "Case Sensitive", "", false, OptionType.ComparisonCaseSensitive),
